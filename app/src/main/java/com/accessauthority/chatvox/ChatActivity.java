...
import com.accessauthority.chatvox.databinding.ActivityChatBinding;
...
//                showToasts("Notification sent successfully");
            ...
            public void onFailure(@Nonnull Call<String> call, @Nonnull Throwable throwable) {
               showToasts(throwable.getMessage());
            }
        });
   }
    private void listenAvailablityReceiver(){
    ...
    private void loadReceiverDetails() {
        receiverUser = (User1) getIntent().getSerializableExtra(Constants.KEY_USER);
        binding.textName.setText(receiverUser.name);
    }
    private  void setListeners(){
        binding.imgInfo.setOnClickListener(view -> startActivity(new Intent(getApplicationContext(),UserDetailActivity.class)));
